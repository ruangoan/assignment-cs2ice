...
@Component({
  selector: 'app-west-coast',
  templateUrl: './west-coast.component.html',
  styleUrls: ['./west-coast.component.css']
})
export class WestCoastComponent implements OnInit {
  ...
  getGames(): void {
    ...
    .subscribe(temp => {this.games = temp
      .filter(
      (team: any) =>
        (team.complete == 100 && team.ateam ) =='West Coast' ||
        (team.complete == 100 && team.hteam ) =='West Coast'
    );})
